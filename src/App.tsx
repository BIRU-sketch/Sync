...
function AppContent() {
  const { currentState, setState, setMicLevel } = useUIState()
  ...
  const handleStateCycle = () => {
    const states: Array<'idle' | 'listening' | 'thinking' | 'talking' | 'executing'> = ['idle', 'listening', 'thinking', 'talking', 'executing']
